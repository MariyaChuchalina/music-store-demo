...
public class PriceDescendingSorter implements Sorter {

    @Override
    public List<Guitar> sortGuitars(List<Guitar> list) {
        Collections.sort(list, Comparator.comparingDouble(Guitar::getPrice).reversed());
        return list;
    }

    @Override
    public List<Accessory> sortAccessories(List<Accessory> list) {
        Collections.sort(list, Comparator.comparingDouble(Accessory::getPrice).reversed());
        return list;
    }
}
